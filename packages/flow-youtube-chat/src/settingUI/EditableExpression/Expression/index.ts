import type ArrayExpression from
  '@/settingUI/EditableExpression/ArrayExpression';
...
import type MemberExpression from
  '@/settingUI/EditableExpression/MemberExpression';
