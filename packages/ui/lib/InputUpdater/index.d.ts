...
type InputUpdater<State, Props, AppCommander> = <K extends keyof Props>(key: K) => (setter: Setter<string, Props[K]>) => (c: AppCommander) => (s: State, e: Event) => StateDispatchable<State>;
