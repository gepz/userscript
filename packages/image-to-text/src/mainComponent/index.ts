    ...
    h('input', {
      ...
      onchange: (s, e: Event) => pipe(
        ...
        TO.apS('characters', pipe(
          ...
          '　！＠＃＄％＾＆＊（）＿＋｛｝：＜＞？１２３４５６７８９０－＝「」；、。・｜あ亜哀挨愛曖悪握圧扱宛嵐安案暗い以衣位囲医依委威為畏胃尉異移萎偉椅彙意違維慰遺緯域育一壱逸茨芋引印因咽姻員院淫陰飲隠韻う右宇羽雨唄鬱畝浦運雲え永泳英映栄営詠影鋭衛易疫益液駅悦越謁閲円延沿炎怨宴媛援園煙猿遠鉛塩演縁艶お汚王凹央応往押旺欧殴桜翁奥横岡屋億憶臆虞乙俺卸音恩温穏か下化火加可仮何花佳価果河苛科架夏家荷華菓貨渦過嫁暇禍靴寡歌箇稼課蚊牙瓦我画芽賀雅餓介回灰会快戒改怪拐悔海界皆械絵開階塊楷解潰壊懐諧貝外劾害崖涯街慨蓋該概骸垣柿各角拡革格核殻郭覚較隔閣確獲嚇穫学岳楽額顎掛潟括活喝渇割葛滑褐轄且株釜鎌刈干刊甘汗缶完肝官冠巻看陥乾勘患貫寒喚堪換敢棺款間閑勧寛幹感漢慣',
          (x) => [...x],
          TO.of,
        )),
